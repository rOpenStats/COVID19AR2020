...
reprex({
 ...
 departamentos2plot %<>% mutate(rank = dense_rank(desc(positividad.porc)))
 nrow(departamentos2plot)
 ...
 covplot
 # ggsave(file.path(data.dir, paste("caba-provincias-departamentos-confirmados-tests",".png", sep ="")),
 #        covplot,
 ...
 covplot <- setupTheme(covplot, report.date = report.date, x.values = dates, x.type = "dates",
                      ...
                      data.provider.abv = "@msalnacion", base.size = 6)
 covplot
 # ggsave(file.path(data.dir, paste("caba-provincias-departamentos-positividad",".png", sep ="")),
 #        covplot,
 #        width = 7, height = 5, dpi = 300)
 ...
 covplot <- covplot + scale_y_log10()
 covplot
 # ggsave(file.path(data.dir, paste("resto-provincias-departamentos-confirmados-tests",".png", sep ="")),
 #        covplot,
 #        width = 7, height = 5, dpi = 300)
 ...
 covplot <- setupTheme(covplot, report.date = report.date, x.values = dates, x.type = "dates",
                       ...
                       data.provider.abv = "@msalnacion", base.size = 6)
 covplot
 # ggsave(file.path(data.dir, paste("resto-provincias-departamentos-positividad",".png", sep ="")),
 #        covplot,
 #        width = 7, height = 5, dpi = 300)
})
